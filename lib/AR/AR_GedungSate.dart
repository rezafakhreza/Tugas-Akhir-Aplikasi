...
class ARGedungSateWidget extends StatefulWidget {
  ARGedungSateWidget({Key? key}) : super(key: key);
  @override
  _ARGedungSateWidgetState createState() => _ARGedungSateWidgetState();
}

class _ARGedungSateWidgetState extends State<ARGedungSateWidget> {
  ...
  List<Widget> _buildCards() {
    return [
      ...
      _buildCardWithYouTubeThumbnail(
        'Tentang Gedung Sate',
        'Sumber Video : youtube Humas Jabar',
        'https://youtu.be/Trh7Axb121E?si=KKaRF8c7OM4hvtnk',
      ),
    ];
  }
  ...
  List<Widget> _buildCards1() {
    return [
      _buildCardWithModelAndImage('Objek Berikut merupakan representasi dari bangunan ikonik Kota Bandung', "MODEL3D/sate.glb", "Images/gedungsate.png"),
    ];
  }
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text("Tentang Gedung Sate"),
  ...
  Future<void> onPlaneOrPointTapped(
    ...
    if (singleHitTestResult != null) {
      ...
      if (didAddAnchor!) {
        ...
        var newNode = ARNode(
            type: NodeType.localGLTF2,
            uri: "Models/AKUBERSERAH/akuberserah.gltf",
            scale: VectorMath.Vector3(0.2, 0.2, 0.2),
