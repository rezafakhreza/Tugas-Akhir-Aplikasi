...
class _LocalAndWebObjectsWidgetState extends State<LocalAndWebObjectsWidget> {
  ...
  List<Widget> _buildCards() {
    return [
      ...
      _buildCardWithImageAndDescription('Objek Berikut merupakan representasi dari Gedung yang mengelilingi sekitar taman kiara yang dimana gedung tersebut terdiri dari beberapa food court dan tenant yang ada di Kiara Artha Park.', 'Images/3D.png'),
    ];
  }
  ...
  Widget _buildCardWithImageAndDescription(String description, String imagePath) {
    return ClipRRect(
      borderRadius: BorderRadius.circular(20.0),
      child: BackdropFilter(
        filter: ImageFilter.blur(sigmaX: 2, sigmaY: 2),
                ...
                ClipRRect(
                  ...
                  child: Container(
                    ...
                    child: Transform.scale(
                      scale: 0.8, // Sesuaikan dengan faktor skala yang diinginkan
                      child: Image.asset(
                        imagePath,
                        fit: BoxFit.cover,
                      ),
