...
class ARkiaraWidget extends StatefulWidget {
  ARkiaraWidget({Key? key}) : super(key: key);
  @override
  _ARkiaraWidgetState createState() => _ARkiaraWidgetState();
}

class _ARkiaraWidgetState extends State<ARkiaraWidget> {
  ...
  List<Widget> _buildCards2() {
    return [
    _buildCardWithTitleAndImage('Lokasi Kiara Artha Park', 'Images/map1.png'),
    ];
  }
  ...
  List<Widget> _buildCards1() {
    return [
      _buildCardWithModelAndImage('Objek Berikut merupakan representasi dari Gedung yang mengelilingi sekitar taman kiara yang dimana gedung tersebut terdiri dari beberapa food court dan tenant yang ada di Kiara Artha Park.', "MODEL3D/gedung.glb", "Images/kiaraB.png"),
      _buildCardWithModelAndImage('Objek Berikut merupakan representasi dari wisata utama dari kiara artha park ini merupakan sebuah taman dengan danau ditengahnya yang akan mengeluarkan air mancur berwarna warni setiap malam', "MODEL3D/park.glb", "Images/park.png"),
      _buildCardWithModelAndImage('Objek Berikut merupakan representasi dari pintu masuk kedalam wisata Kiara Artha Park.', "MODEL3D/gate.glb", "Images/kiara.png"),
    ];
  }
  ...
  void _launchMaps() async {
    const url = 'https://maps.app.goo.gl/ngHBBGRaiCUS9Lnv9'; // Ganti dengan URL atau koordinat lokasi yang ingin Anda buka di aplikasi peta
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
            ...
            onTap: () {
              Navigator.pushReplacement(
                ...
                PageTransition(
                  ...
                  child: DetailWisata3(), // ganti destinationPage dengan halaman tujuan Anda
                ),
              );
            },
            child: Container(
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text("Tentang Kiara Artha Park"),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text("Lokasi Kiara Artha Park"),
                              style: OutlinedButton.styleFrom(
                                side: BorderSide(color: Colors.white, width: 2.0),
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(12.0),
  ...
  Future<void> onPlaneOrPointTapped(
    ...
    if (singleHitTestResult != null) {
      ...
      if (didAddAnchor!) {
        ...
        var newNode = ARNode(
            type: NodeType.localGLTF2,
            uri: "Models/AKUBERSERAH/kiaraartha.gltf",
            scale: VectorMath.Vector3(0.2, 0.2, 0.2),
