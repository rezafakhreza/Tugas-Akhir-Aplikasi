...
class ARTSBWidget extends StatefulWidget {
  ARTSBWidget({Key? key}) : super(key: key);
  @override
  _ARTSBWidgetState createState() => _ARTSBWidgetState();
}

class _ARTSBWidgetState extends State<ARTSBWidget> {
  ...
  List<Widget> _buildCards2() {
    return [
      _buildCardWithTitleAndImage('Lokasi Trans Studio Bandung', 'Images/map3.png'),
    ];
  }
  ...
  List<Widget> _buildCards1() {
    return [
      _buildCardWithModelAndImage('Objek Berikut merupakan representasi dari bangunan Trans Studio Bandung', "MODEL3D/trans.glb", "Images/tsb.png"),
    ];
  }
            ...
            onTap: () {
              Navigator.pushReplacement(
                ...
                PageTransition(
                  ...
                  child: DetailWisata2(), // ganti destinationPage dengan halaman tujuan Anda
                ),
              );
            },
            child: Container(
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text("Tentang Trans Studio Bandung"),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text("Lokasi Trans Studio Bandung"),
                              style: OutlinedButton.styleFrom(
                                side: BorderSide(color: Colors.white, width: 2.0),
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(12.0),
