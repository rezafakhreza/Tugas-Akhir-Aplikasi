...
class LokasiDetail1 extends StatefulWidget {
  const LokasiDetail1({Key? key}) : super(key: key);

  @override
  _LokasiDetail1State createState() => _LokasiDetail1State();
}
class _LokasiDetail1State extends State<LokasiDetail1> {
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage('Images/map3.png'), // Ganti dengan path gambar Anda
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
