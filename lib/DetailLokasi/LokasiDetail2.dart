...
class LokasiDetail2 extends StatefulWidget {
  const LokasiDetail2({Key? key}) : super(key: key);

  @override
  _LokasiDetail2State createState() => _LokasiDetail2State();
}
class _LokasiDetail2State extends State<LokasiDetail2> {
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage('Images/map1.png'), // Ganti dengan path gambar Anda
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
