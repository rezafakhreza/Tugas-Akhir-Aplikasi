...
import 'package:ta/AR/WarningAR2.dart';
...
import 'package:ta/DetailLokasi/LokasiDetail2.dart';
...
class DetailWisata3 extends StatefulWidget {
  const DetailWisata3 ({Key? key}) : super(key: key);

  @override
  _DetailWisata3State createState() => _DetailWisata3State();
}
...
class _DetailWisata3State extends State<DetailWisata3> {
  final PageController _pageController = PageController();
  int _currentPage = 0;
  bool _isFavorited = false; // Menyimpan status favorit

  void _launchMaps() async {
    const url = 'https://maps.app.goo.gl/Ky2S5gUbFabPUtRV6'; // Ganti dengan URL atau koordinat lokasi yang ingin Anda buka di aplikasi peta
  ...
  final List<Facility> facilities = [
    Facility(name: 'Food Court', icon: Icons.storefront_rounded),
    ...
    Facility(name: 'Sepeda', icon: Icons.directions_bike_rounded),
          ...
          SliverAppBar(
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () {
                    ...
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (context) => WarningAR2()),
                    );
                  },
                  child: Icon(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: PageView(
                ...
                children: [
                  Image.asset('Images/kiara.png', fit: BoxFit.cover),
                  Image.asset('Images/artha.jpg', fit: BoxFit.cover),
                  Image.asset('Images/mancur.jpg', fit: BoxFit.cover),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          '10.00 - 21.00 WIB', // Teks di sebelah kanan
                          style: TextStyle(
                            fontFamily: 'Poppins',
                            fontWeight: FontWeight.w600,
                            fontSize: 14.0,
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(15),
                            child: Image.asset(
                              'Images/kiaramap.png', // Ganti dengan path relatif dari gambar yang ingin ditambahkan
                          ...
                          children: <Widget>[
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => LokasiDetail2()),
                                );
                              },
                              child: Align(
