...
import 'package:ta/ARKatalog/AR_GedungSate.dart';
import 'package:page_transition/page_transition.dart';

class WarningAR extends StatefulWidget {
  const WarningAR({Key? key}) : super(key: key);

  @override
  _WarningARState createState() => _WarningARState();
}

class _WarningARState extends State<WarningAR> {
  @override
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      PageTransition(
                        ...
                        child: ARGedungSateWidget(), // ganti destinationPage dengan halaman tujuan Anda
                      ),
                    );
                  },
