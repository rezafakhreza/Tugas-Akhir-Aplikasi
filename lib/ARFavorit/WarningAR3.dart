...
import 'package:ta/ARFavorit/AR_TSB.dart';
import 'package:page_transition/page_transition.dart';

class WarningAR3 extends StatefulWidget {
  const WarningAR3({Key? key}) : super(key: key);

  @override
  _WarningAR3State createState() => _WarningAR3State();
}

class _WarningAR3State extends State<WarningAR3> {
  @override
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      PageTransition(
                        ...
                        child: ARTSBWidget(), // ganti destinationPage dengan halaman tujuan Anda
                      ),
                    );
                  },
