...
import 'package:ta/ARFavorit/AR_Museum.dart';
import 'package:page_transition/page_transition.dart';

class WarningAR1 extends StatefulWidget {
  const WarningAR1({Key? key}) : super(key: key);

  @override
  _WarningAR1State createState() => _WarningAR1State();
}

class _WarningAR1State extends State<WarningAR1> {
  @override
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      PageTransition(
                        ...
                        child: ARMuseumWidget(), // ganti destinationPage dengan halaman tujuan Anda
                      ),
                    );
                  },
